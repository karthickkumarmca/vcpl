...
class TableCenteringTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('centering_transactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('centering_transactions');
    }
}
