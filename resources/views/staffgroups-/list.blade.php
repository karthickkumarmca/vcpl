            ...
            'action_button' : {
                ...
                'action': [
                {
                    "name"      : "Edit",
                        ...
                        "title"     : 'Edit',
                        "url"       : function(data){
                            return "edit-staffgroups/"+data['uuid'];
                        },
                        "icon"      : "fa fa-pencil",
                        "method"    : "get",
                    ...
                    },
                    {
                        ...
                        "title"     : 'View',
                        "url"       : function(data){
                            return "view-staffgroups/"+data['uuid'];
                        },
                        "icon"      : "fa fa-eye",
                        "method"    : "get",
                        condition: function(data) {
                    ...
                    },
                    {
                        ...
                        "title"     : 'Change status',
                        "url"       : function(data){
                            return "staffgroups-update-status/"+data['uuid'];
                        },
                        "icon"      : "fa fa-check",
                        "method"    : "get",
                        "condition" : function(data){
                    ...
                    },
                    {
                        ...
                        "title"     : 'Delete',
                        "url"       : function(data){
                            return "staffgroups/delete/"+data['uuid'];
                        },
                        "icon"      : "fa fa-trash",
                        "method"    : "get",
                        /*"condition" : function(data){
