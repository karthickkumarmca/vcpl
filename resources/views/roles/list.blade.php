                ...
                <div class="box-header with-border">
                    <div class="box-tools">
                        <div class="btn-group">
                            @isset($create_access)
                            @if ($create_access == 1)
                            <a href="{{ url(route('create-roles')) }}" class="btn btn-sm btn-primary"><i class="fa fa-plus fa-fw"></i>Create Roles</a>
                            @endif
                            @endisset
                        </div>
                    </div>
...
<script type="text/javascript">
            ...
            'action_button' : {
                ...
                'action': [
                {
                    ...
                    },
                    {
                        ...
                        "title"     : 'Change status',
                        "url"       : function(data){
                            return "roles-update-status/"+data['uuid'];
                        },
                        "icon"      : "fa fa-check",
                        "method"    : "get",
                        "condition" : function(data){
                        ...
                        "function_call" : "changerolesStatus"
                    },
                    {
                        "name"      : "In-Active",
                        "type"      : "dialog", //view,dialog,modal
         ...
         * @param Object current object
         */
         function changerolesStatus(current) {
            var is_confirm = $(current).data('is_confirm');
            var method = $(current).data('method');
            var url = $(current).data('url');
            if(is_confirm) {
         ...
         * @param string method
         */
         function updateRolesStatus(url, method) {
            var request  = {
                'url'             : url,
                'type'            : method,
                'data'            : {},
