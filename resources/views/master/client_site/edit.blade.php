					...
					<div class="box-body">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate" placeholder="Enter Name" name="client_name" value="{{old('client_name') ? old('client_name') : $client_site->client_name}}" minlength="1"maxlength="100"/>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate" autocomplete="off" placeholder="Enter Cader" name="cader" value="{{old('cader') ? old('cader') : $client_site->cader}}" data-rule="admin" minlength="1" maxlength="100"/>
								<span class="validation_error"></span>
								@if($errors->has('cader'))
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate number_restrict" autocomplete="off" placeholder="Enter Moble Number" name="mobile_number" value="{{old('mobile_number') ? old('mobile_number') : $client_site->mobile_number}}" data-rule="admin" minlength="1" maxlength="10"/>
								<span class="validation_error"></span>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate email" autocomplete="off" placeholder="Enter Email id" name="email_id" value="{{old('email_id') ? old('email_id') : $client_site->email_id}}" data-rule="admin" minlength="1" maxlength="100"/>
								<span class="validation_error"></span>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate" autocomplete="off" placeholder="Enter Address" name="address" value="{{old('address') ? old('address') : $client_site->address}}" data-rule="admin" minlength="1" maxlength="100"/>
								<span class="validation_error"></span>
