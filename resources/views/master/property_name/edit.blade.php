			...
			<form id="admin-form" method="post" enctype="multipart/form-data" action="{{URL::to('master/property-name/store')}}">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Edit Property name</h3>
					</div>
					<div class="box-body">
					<div class="col-md-12">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate" placeholder="Enter Name" name="property_name" value="{{old('property_name') ? old('property_name') : $property_name->property_name}}" maxlength="128"/>
								<span class="validation_error"></span>
...
<div class="col-md-12">
								...
								<select name="ownership_id" class="form-control pos_validate" id="ownership_id">
									...
									@isset($ownership)
										@foreach($ownership as $owner)
											@if(old('ownership_id') != "")
												@if(old('ownership_id') == $owner['id'])
													<option value="{{$owner['id']}}" selected>{{$owner['ownership_name']}}</option>
												@else
				...
				<input type="hidden" name="property_name_id" value="{!! $property_name->uuid !!}" />
			</form>
		</div>
	</div>
</section>
