            ...
            <form id="admin-form">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Reset staff password</h3>
                    </div>
                ...
                <input type="hidden" name="user_id" id ="user_id" value="{{ $data['encrypt_id'] }}">
            </form>
        </div>
    </div>
</div>
            ...
            function processCurrentResponse(response, status_code)
            {
                if (response)
                {
                    if (status_code == appConfig.response_code.ok)
                    {
                        ...
                        window.location.href = "{{ route('staff-details-list') }}";
