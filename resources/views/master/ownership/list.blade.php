...
<section class="content-header">
    <h1 class="col-lg-6 no-padding">Labour Ownership <small>Management</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-header with-border">
                    <div class="box-tools">
                        <div class="btn-group">
                            @isset($create_access)
                            @if ($create_access == 1)
                            <a href="{{ url(route('create-ownership')) }}" class="btn btn-sm btn-primary"><i class="fa fa-plus fa-fw"></i>Create Ownership</a>
                            @endif
                            @endisset
                        </div>
                    </div>
                    <h3 class="box-title">Ownership List</h3>
                </div>
                <div class="box-body">
