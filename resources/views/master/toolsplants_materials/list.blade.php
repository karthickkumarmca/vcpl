...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Tools and Plants materials</li>
    </ol>
</section>
                ...
                <div class="box-header with-border">
                    <div class="box-tools">
                        <div class="btn-group">
                            @isset($create_access)
                            @if ($create_access == 1)
                            <a href="{{ url(route('create-toolsplants-materials')) }}" class="btn btn-sm btn-primary"><i class="fa fa-plus fa-fw"></i>Create Tools and Plants materials</a>
                            @endif
                            @endisset
                        </div>
                    </div>
                    <h3 class="box-title">Tools and Plants materials List</h3>
                </div>
                <div class="box-body">
