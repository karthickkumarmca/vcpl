                ...
                <div class="box-header with-border">
                    <div class="box-tools">
                        <div class="btn-group">
                            @isset($create_access)
                            @if ($create_access == 1)
                            <a href="{{ url(route('create-lorry-materials')) }}" class="btn btn-sm btn-primary"><i class="fa fa-plus fa-fw"></i>Create Lorry materials</a>
                            @endif
                            @endisset
                        </div>
                    </div>
                    <h3 class="box-title">Lorry materials List</h3>
                </div>
                <div class="box-body">
