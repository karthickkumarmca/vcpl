...
<section class="content">
	<div class="row">
		<div class="col-sm-12">
			<form id="admin-form" method="post" enctype="multipart/form-data" action="{{URL::to('staffgroups/store')}}">
				@csrf
					...
					<div class="box-body">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control pos_validate" autocomplete="off" placeholder="Enter Staff Group" name="group_name" value="{{old('group_name')}}" data-rule="admin" minlength="3" maxlength="128"/>
