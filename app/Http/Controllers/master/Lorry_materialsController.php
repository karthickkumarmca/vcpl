...
class Lorry_materialsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if(!isset($rolesAccess['lorry_materials_management']) || $rolesAccess['lorry_materials_management']!=1){
            abort(403);
        } else {
            if ($request->has('request_type')) {
                ...
                if(isset($rolesAccess['lorry_materials_management_access'])){
                    ...
                    $change_status_access   = $rolesAccess['lorry_materials_management_access']['change_status'];
    ...
    {
        $rolesAccess = Session::get('role_access');
        if(!isset($rolesAccess['lorry_materials_management_access']['create']) || $rolesAccess['lorry_materials_management_access']['create']!=1){
            abort(403);
        } else {
            $search = ['status' => 1,'category_id'=>3];
    ...
    {
       $rolesAccess = Session::get('role_access');
        if(!isset($rolesAccess['lorry_materials_management_access']['view']) || $rolesAccess['lorry_materials_management_access']['view']!=1){
            abort(403);
        } else {
    ...
    {
        $rolesAccess = Session::get('role_access');
        if(!isset($rolesAccess['lorry_materials_management_access']['edit']) || $rolesAccess['lorry_materials_management_access']['edit']!=1){
            abort(403);
        } else {
