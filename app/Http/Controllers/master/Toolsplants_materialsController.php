    ...
    public function list(Request $request)
    {
        ...
        if(!isset($rolesAccess['toolsplants_materials_management']) || $rolesAccess['toolsplants_materials_management']!=1){
            ...
            if ($request->has('request_type')) {
                ...
                return view('master.toolsplants_materials.list', compact('statuses','Productdetails','units', 'create_access', 'view_access', 'edit_access', 'delete_access', 'change_status_access'));
            }
        }
    }
